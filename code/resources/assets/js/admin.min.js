 ...
 */
if(window.jQuery=window.kQuery,/*!
 * Select2 4.0.3
 ...
 * @link		https://github.com/joomlatools/joomlatools-framework for the canonical source repository
 */
"undefined"==typeof Kodekit&&(Kodekit={}),function(a){Kodekit.Grid=Kodekit.Class.extend({initialize:function(b){var c=this;this.element=a(b),this.form=this.element.is("form")?this.element:this.element.closest("form"),this.checkall=this.element.find(".k-js-grid-checkall"),this.checkboxes=this.element.find(".k-js-grid-checkbox").filter(function(b,c){return!a(c).prop("disabled")}),this.checkboxes.length||this.checkall.prop("disabled",!0),this.checkall.on("change.kodekit",function(b,d){d||c.checkAll(a(this).prop("checked"))}),this.checkboxes.on("change.kodekit",function(a,b){b||c.setCheckAll()}),this.setScopebar(),this.setTableHeaders(),this.setTableRows()},setScopebar:function(){var b=this;a(".k-js-filter-container",this.form).scopebar({beforeSubmitForm:function(){b.uncheckAll()}})},setTableHeaders:function(){this.form.on("click.kodekit","th",function(b){var c=a(b.target),d=c.find("a");if(d.length)d.prop("href")?window.location.href=d.prop("href"):d.trigger("click",b);else{var e=c.find(".k-js-grid-checkall");e.length&&e.prop("checked",!e.is(":checked")).trigger("change")}})},setTableRows:function(){this.form.on("click.kodekit","tr",function(b){var c=a(b.target);if(!c.is("[type=radio], [type=checkbox], a[href], span.footable-toggle")){var d=c.is("tr")?c:c.parents("tr"),e=d.find(".k-js-grid-checkbox");1!=d.data("readonly")&&e.length&&e.length&&e.prop("checked",!e.prop("checked")).trigger("change")}}),a(".k-js-grid-checkbox").on("change.kodekit",function(b){var c,d=a(b.target),e=d.parents("tr"),f=e.parent();d.is("[type=radio]")&&f.find(".k-is-selected").removeClass("k-is-selected"),a(this).prop("checked")?e.addClass("k-is-selected"):e.removeClass("k-is-selected"),c=f.find(".k-is-selected").length,c>1?f.addClass("k-has-selected-multiple").removeClass("k-has-selected-single"):1===c?f.removeClass("k-has-selected-multiple").addClass("k-has-selected-single"):f.removeClass("k-has-selected-multiple").removeClass("k-has-selected-single")}).trigger("change",!0)},checkAll:function(b){var c=this.checkboxes.filter(function(c,d){return a(d).prop("checked")!==b});this.checkboxes.prop("checked",b),c.trigger("change",!0)},uncheckAll:function(){this.checkAll(!1)},setCheckAll:function(){var b=this.checkboxes.filter(function(b,c){return a(c).prop("checked")!==!1}).length;this.checkall.prop("checked",this.checkboxes.length===b),this.checkall.trigger("change",!0)}}),Kodekit.Grid.getAllSelected=function(b){return a(".k-js-grid-checkbox:checked",b)},Kodekit.Grid.getIdQuery=function(a){return decodeURIComponent(this.getAllSelected(a).serialize())},a(function(){a(".k-js-grid").each(function(b,c){new Kodekit.Grid(a(c))})})}(window.kQuery),/**
 ...
 *
 */
function(a){function b(b){var c=a(b),d=a(":focus"),e=0;if(1===d.length){var f=c.index(d);f+1<c.length&&(e=f+1)}c.eq(e).focus()}function c(b){var c=a(b),d=a(":focus"),e=c.length-1;if(1===d.length){var f=c.index(d);f>0&&(e=f-1)}c.eq(e).focus()}function d(b){function c(b){return a.expr.filters.visible(b)&&!a(b).parents().addBack().filter(function(){return"hidden"===a.css(this,"visibility")}).length}var d,e,f,g=b.nodeName.toLowerCase(),h=!isNaN(a.attr(b,"tabindex"));return"area"===g?(d=b.parentNode,e=d.name,!(!b.href||!e||"map"!==d.nodeName.toLowerCase())&&(f=a("img[usemap=#"+e+"]")[0],!!f&&c(f))):(/input|select|textarea|button|object/.test(g)?!b.disabled:"a"===g?b.href||h:h)&&c(b)}a.focusNext=function(){b(":focusable")},a.focusPrev=function(){c(":focusable")},a.tabNext=function(){b(":tabbable")},a.tabPrev=function(){c(":tabbable")},a.extend(a.expr[":"],{data:a.expr.createPseudo?a.expr.createPseudo(function(b){return function(c){return!!a.data(c,b)}}):function(b,c,d){return!!a.data(b,d[3])},focusable:function(a){return d(a)},tabbable:function(b){var c=a.attr(b,"tabindex"),e=isNaN(c);return(e||c>=0)&&d(b)}})}(kQuery),/* @preserve
 * Off canvas menu
 * Copyright 2015 Robin Poort
 * http://www.robinpoort.com
 */
function(a){a.offCanvasMenu=function(b,c){var d={menu:a(b),position:"left",menuExpandedClass:"k-show-left-menu",openedClass:"k-is-opened",noTransitionClass:"k-no-transition",wrapper:a(b).parent(),container:a(".container"),menuToggle:[],expandedWidth:a(b).outerWidth(),offCanvasOverlay:"k-off-canvas-overlay",ariaControls:null,opacity:.75},e=this;e.settings={},e.init=function(){function b(a){v.bind("keydown",function(b){9===b.keyCode&&t.hasClass(q)&&(b.preventDefault(),b.shiftKey?a.find(":tabbable").last().focus():a.find(":tabbable").first().focus())}),a.find(":tabbable").first().bind("keydown",function(a){9===a.keyCode&&t.hasClass(q)&&a.shiftKey&&(a.preventDefault(),v.focus())}),a.find(":tabbable").last().bind("keydown",function(a){9===a.keyCode&&t.hasClass(q)&&(a.shiftKey||(a.preventDefault(),v.focus()))})}function f(a){clearTimeout(n),v.attr({"aria-expanded":"true"}),t.addClass(q+" "+r+"-"+p),n=setTimeout(function(){b(a)},z)}function g(){clearTimeout(n),v.attr({"aria-expanded":"false"}),t.removeClass(q),n=setTimeout(function(){t.removeClass(r+"-"+p)},z)}function h(a,b){if(t.is('[class*="'+r+'"]')&&!t.is('[class*="'+r+"-"+p+'"]')){var c=t.find('button[class^="k-off-canvas-menu-toggle"]').not(v);c.trigger("click")}b.stopPropagation();var d=t.hasClass(q)?"k-is-opened":"k-is-closed";"k-is-closed"===d&&f(a),"k-is-opened"===d&&g()}function i(){return"left"==p?o.offset().left+x:o.offset().left}function j(a){return"left"==p&&a>=-25&&a<=x||"right"==p&&a>=-x&&a<=25}function k(b){t.hasClass(q)&&(E=!0,C=b.originalEvent.touches[0].pageX,F={startingX:i(),pageX:C,pageY:b.originalEvent.touches[0].pageY},B=t.position().left,G=void 0,D=e.settings.opacity,a.each(A,function(){a(this).addClass(s)}),a.each(y,function(){a(this).addClass(s)}),b.stopPropagation())}function l(b){if(t.hasClass(q)&&(B=b.originalEvent.touches[0].pageX-F.pageX,"undefined"==typeof G&&(G=!!(G||Math.abs(B)<Math.abs(b.originalEvent.touches[0].pageY-F.pageY))),!G)){b.preventDefault();var c="left"==p?F.startingX+B:B-(a(window).width()-F.startingX),d=D/x*Math.abs(c);if(!j(c))return;a.each(A,function(){a(this).hasClass("k-title-bar--mobile")||a(this).css({"-webkit-transform":"translate("+c+"px, 0)","-moz-transform":"translate("+c+"px, 0)","-ms-transform":"translate("+c+"px, 0)","-o-transform":"translate("+c+"px, 0)",transform:"translate("+c+"px, 0)"})}),a.each(y,function(){a(this).css("opacity",d)}),b.stopPropagation()}}function m(b){if(E&&t.hasClass(q)){var c="left"==p?F.startingX+B:B-(a(window).width()-F.startingX),d=Math.abs(c);G||(a.each(A,function(){u.removeAttr("style").removeClass(s),a(".k-js-title-bar").removeAttr("style").removeClass(s)}),a.each(y,function(){a(this).removeAttr("style").removeClass(s)}),"left"==p&&(d<=.66*x||c<=0)||"right"==p&&(d<=.66*x||c>=0)?g():f(o)),E=null,F={},b.stopPropagation()}}e.settings=a.extend({},d,c);var n,o=e.settings.menu,p=e.settings.position,q=e.settings.menuExpandedClass,r=e.settings.openedClass,s=e.settings.noTransitionClass,t=e.settings.wrapper,u=e.settings.container,v=e.settings.menuToggle,w=e.settings.ariaControls,x=o.outerWidth(),y=a("."+e.settings.offCanvasOverlay),z=Math.round(1e3*parseFloat(u.css("transition-duration"))),A=e.settings.transitionElements||e.settings.container;"right"!==p||c.menuExpandedClass||(q="k-show-right-menu"),t.is("body")&&(t=a("html, body")),a.each(A,function(){if(void 0==a(this).find("."+e.settings.offCanvasOverlay)[0]){a(this).append('<div class="'+e.settings.offCanvasOverlay+'">');var b=a("."+e.settings.offCanvasOverlay);a.extend(y,b)}}),v.length&&(v.attr({role:"button","aria-controls":w,"aria-expanded":"false"}),v.click(function(a){v.is(":visible")&&h(o,a)}),t.click(function(a){t.hasClass(q)&&(a.stopPropagation(),g())}),o.click(function(a){a.stopPropagation()}),a(document).bind("keydown",function(a){27===a.keyCode&&t.hasClass(q)&&(a.stopPropagation(),g(),v.focus())})),"ontouchstart"in document.documentElement&&(t.on("touchstart",k),t.on("touchmove",l),t.on("touchend",m));var B,C,D,E=null,F={},G=!1},e.init()},a.fn.offCanvasMenu=function(b){return this.each(function(){if(void 0==a(this).data("offCanvasMenu")){var c=new a.offCanvasMenu(this,b);a(this).data("offCanvasMenu",c)}})}}(kQuery);var Konami=function(a){var b={addEvent:function(a,b,c,d){a.addEventListener?a.addEventListener(b,c,!1):a.attachEvent&&(a["e"+b+c]=c,a[b+c]=function(){a["e"+b+c](window.event,d)},a.attachEvent("on"+b,a[b+c]))},input:"",pattern:"38384040373937396665",load:function(a){this.addEvent(document,"keydown",function(c,d){if(d&&(b=d),b.input+=c?c.keyCode:event.keyCode,b.input.length>b.pattern.length&&(b.input=b.input.substr(b.input.length-b.pattern.length)),b.input==b.pattern)return b.code(a),b.input="",c.preventDefault(),!1},this),this.iphone.load(a)},code:function(a){window.location=a},iphone:{start_x:0,start_y:0,stop_x:0,stop_y:0,tap:!1,capture:!1,orig_keys:"",keys:["UP","UP","DOWN","DOWN","LEFT","RIGHT","LEFT","RIGHT","TAP","TAP"],code:function(a){b.code(a)},load:function(a){this.orig_keys=this.keys,b.addEvent(document,"touchmove",function(a){if(1==a.touches.length&&1==b.iphone.capture){var c=a.touches[0];b.iphone.stop_x=c.pageX,b.iphone.stop_y=c.pageY,b.iphone.tap=!1,b.iphone.capture=!1,b.iphone.check_direction()}}),b.addEvent(document,"touchend",function(c){1==b.iphone.tap&&b.iphone.check_direction(a)},!1),b.addEvent(document,"touchstart",function(a){b.iphone.start_x=a.changedTouches[0].pageX,b.iphone.start_y=a.changedTouches[0].pageY,b.iphone.tap=!0,b.iphone.capture=!0})},check_direction:function(a){x_magnitude=Math.abs(this.start_x-this.stop_x),y_magnitude=Math.abs(this.start_y-this.stop_y),x=this.start_x-this.stop_x<0?"RIGHT":"LEFT",y=this.start_y-this.stop_y<0?"DOWN":"UP",result=x_magnitude>y_magnitude?x:y,result=1==this.tap?"TAP":result,result==this.keys[0]&&(this.keys=this.keys.slice(1,this.keys.length)),0==this.keys.length&&(this.keys=this.orig_keys,this.code(a))}}};return"string"==typeof a&&b.load(a),"function"==typeof a&&(b.code=a,b.load()),b};!function(a){a(document).ready(function(){function b(b,c){var d=".k-ui-container",e=b.closest(d),f=e.find(".k-js-title-bar"),g=e.find(".k-js-toolbar"),h=e.find(".k-js-wrapper"),i=e.find(".k-js-content"),j=e.find(".k-js-component"),k=e.find(".k-off-canvas-menu-toggle--"+c),l=a(p),m=null,n=i;l.addClass("k-off-canvas-menu-toggle-holder--"+c).children("button").addClass("k-off-canvas-menu-toggle--"+c),0===k.length&&("left"==c?f.length?f.prepend(l):g.length&&g.prepend(l):"right"==c&&(g.length?g.append(l):f.length&&f.append(l),n=j),m=a(".k-off-canvas-menu-toggle--"+c),b.offCanvasMenu({menuToggle:m,wrapper:h,container:i,position:c,transitionElements:n}))}function c(b){b.on("click",function(b){b.preventDefault(),u.hasClass(w)&&a(this).hasClass(x)?f():d(a(this))})}function d(b){u.hasClass(w)&&a(this).hasClass(x)?f():(a("."+x).removeClass(x),b.addClass(x),u.addClass(w))}function e(){v.on("mouseover",function(b){3==a(".k-menu-container").css("z-index")&&(b.preventDefault(),u.hasClass(w)&&d(a(this)))})}function f(){u.removeClass(w).find("."+x).removeClass(x)}function g(){if(A.length){var a=G.outerWidth(),b=A.innerWidth(),c=A.scrollLeft();a>b?H.addClass(B):H.removeClass(B),a>b&&c>0&&H.addClass(C),a>b&&H.addClass(D),(a<=b||c<=0)&&H.removeClass(C),(a<=b||c>=a-b)&&H.removeClass(D)}}function h(){var b=a(".k-tabs-scroller-prev"),c=a(".k-tabs-scroller-next");b.on("click",function(){i("prev")}),c.on("click",function(){i("next")})}function i(a){var b,c=G.outerWidth(),d=A.innerWidth(),e=A.scrollLeft();"prev"==a&&(b=e-d*E,b<0&&(b=0)),"next"==a&&(b=e+d*E,b>c-d&&(b=c-d)),A.animate({scrollLeft:b},F)}function j(a){if(a.parent("li").parent("ul").parent().hasClass("k-js-tabs-scroller")){var b,c=a.parent().position().left,d=c+a.parent().outerWidth(),e=parseInt(G.css("padding-left"),10),f=parseInt(G.css("padding-right"),10),g=A.scrollLeft(),h=A.innerWidth();d>g+h&&(b=g+(d-(h+g)+2*f)),c<g&&(b=g-(g-c+2*e)),A.animate({scrollLeft:b},F)}}var k,l=a(".k-js-responsive-table"),m=a(".k-js-sidebar-toggle-item"),n=a(".k-js-scopebar"),o="k-is-resizing";if(a(".k-js-title-bar, .k-js-toolbar").length&&a(".k-js-wrapper").length&&a(".k-js-content").length){var p='<div class="k-off-canvas-menu-toggle-holder"><button class="k-off-canvas-menu-toggle" type="button"><span class="k-toggle-button-bar1"></span><span class="k-toggle-button-bar2"></span><span class="k-toggle-button-bar3"></span></button></div>',q=a(".k-js-sidebar-left"),r=a(".k-js-sidebar-right");if(q.length){a.each(q,function(){b(a(this),"left")});var s=a(".k-tree"),t=a(".k-list");(s.length||t.length)&&(s.on("click",".jqtree-title",function(){a(".k-js-wrapper").hasClass("k-is-opened-left")&&a(".k-off-canvas-menu-toggle--left").trigger("click")}),t.on("click","a",function(){a(".k-js-wrapper").hasClass("k-is-opened-left")&&a(".k-off-canvas-menu-toggle--left").trigger("click")}))}r.length&&(a.each(r,function(){b(a(this),"right")}),a(".k-table-container table").on("click","a",function(b){a(this).hasClass("navigate")||b.stopPropagation(),a(this).parents("td").length>0&&a(".k-off-canvas-menu-toggle--right").trigger("click")}))}var u=a("#k-js-menu");if(u.length){var v=a("#k-js-menu > ul > li > a"),w="has-open-menu",x="has-open-submenu",p='<button type="button" id="k-js-menu-toggle" class="menu-toggle" title="Menu toggle" aria-label="Menu toggle">Menu</button>',y='<div class="k-off-canvas-overlay"></div>';u.parent().append(a(p)),a(".k-js-wrapper").append(a(y)),u.offCanvasMenu({menuToggle:a("#k-js-menu-toggle"),position:"right",container:a(".k-wrapper"),expandedWidth:"276",wrapper:a(".k-ui-container")}),c(v),e(),a(document).mouseup(function(b){var c=a(".k-menu-container__nav > ul");c.is(b.target)||0!==c.has(b.target).length||f()}),a(document).keyup(function(a){27===a.keyCode&&f()})}if(l.footable({toggleSelector:".footable-toggle",breakpoints:{phone:400,tablet:600,desktop:800}}),n.length&&(a.each(n,function(){var b=a(this),c=b.find(".k-scopebar__item--filters"),d=b.find(".k-scopebar__item--search"),e=".k-scopebar__item--toggle-buttons",f='<div class="k-scopebar__item k-scopebar__item--toggle-buttons"></div>';b.find(e).length||b.prepend(f);var g=b.find(e);c.length&&!b.find(".k-toggle-scopebar-filters").length&&g.prepend('<button type="button" class="k-scopebar__button k-toggle-scopebar-filters k-js-toggle-filters"><span class="k-icon-filter" aria-hidden="true"><span class="k-visually-hidden">Filters toggle</span><div class="k-js-filter-count k-scopebar__item-label k-scopebar__item-label--numberless"></div></button>'),d.length&&!b.find(".k-toggle-scopebar-search").length&&(g.prepend('<button type="button" class="k-scopebar__button k-toggle-scopebar-search k-js-toggle-search"><span class="k-icon-magnifying-glass" aria-hidden="true"><span class="k-visually-hidden">Search toggle</span><div class="k-js-search-count k-scopebar__item-label k-scopebar__item-label--numberless" style="display: none"></div></button>'),g.siblings(".k-scopebar__item--search").find(".k-search__field").val()&&a(".k-js-search-count").show())}),a(".k-js-toggle-filters").on("click",function(){a(this).parent().siblings(".k-scopebar__item--filters").slideToggle("fast")}),a(".k-js-toggle-search").on("click",function(){a(this).parent().siblings(".k-scopebar__item--search").slideToggle("fast")})),a(".k-js-select2").select2({theme:"bootstrap"}),a(".k-js-datepicker").kdatepicker(),a(".k-js-image-modal").magnificPopup({type:"image"}),a(".k-js-inline-modal").magnificPopup({type:"inline"}),a(".k-js-iframe-modal").magnificPopup({type:"iframe"}),a(".k-js-tooltip").ktooltip({animation:!0,placement:"top",delay:{show:200,hide:50},container:".k-ui-container"}),m.length){var z=a('<div class="k-sidebar-item__toggle"><span class="k-visually-hidden">Toggle</span></div>');m.addClass("k-sidebar-item--toggle").find(".k-sidebar-item__header").append(z),m.on("click",".k-sidebar-item__toggle",function(b){a(this).toggleClass("k-is-active").parent().next().slideToggle(180)})}new Konami(function(){a("html, .k-ui-container").css({"font-family":"Comic Sans MS","font-size":"20px","line-height":"30px"}).addClass("konami")}),new Kodekit.Tree("#k-jqtree",{data:[{label:"Main category",id:4},{label:"Sub category 1",id:5,parent:4},{label:"Sub category 2",id:6,parent:4},{label:"Deeper category",id:7,parent:6},{label:"Sub category 3",id:8,parent:4}]});var A=a(".k-js-tabs-scroller"),B="k-has-tabs-overflow",C="k-has-tabs-left-overflow",D="k-has-tabs-right-overflow",E=.8,F=400;if(A.length){var G=a(".k-js-tabs"),H=a(".k-js-tabs-wrapper");H.prepend('<button type="button" class="k-tabs-scroller-prev"><span class="k-icon-chevron-left"></span><span class="k-visually-hidden">Scroll left</span></button>'),H.append('<button type="button" class="k-tabs-scroller-next"><span class="k-icon-chevron-right"></span><span class="k-visually-hidden">Scroll right</span></button>'),setTimeout(function(){g(),h(),setTimeout(function(){j(A.find(".k-is-active a"))},F)},500),G.on("click","li a",function(){j(a(this))}),A.on("scroll",function(){clearTimeout(k),k=setTimeout(function(){g()},200)})}a(window).on("resize",function(){a("body").addClass(o),clearTimeout(k),k=setTimeout(function(){a("body").removeClass(o),g()},200)})})}(kQuery),window.jQuery=globalCacheForjQueryReplacement,globalCacheForjQueryReplacement=void 0;